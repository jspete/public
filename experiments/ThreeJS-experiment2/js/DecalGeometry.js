...
var decalGeometry = new THREE.DecalGeometry(  
    ...
    P: position, // THREE.Vector3 in world coordinates  
    R: direction, // THREE.Vector3 specifying the orientation of the decal  
    S: dimensions, // THREE.Vector3 specifying the size of the decal box  
...
var s = new THREE.Vector3( 5, 5, 5 );
var up = new THREE.Vector3( 0, 1, 0 );
var check = new THREE.Vector3( 1, 1, 1 );


var m = new THREE.Mesh( new THREE.DecalGeometry( floor, p, r, s, check ), decalMaterial );
//decals.push( m );
